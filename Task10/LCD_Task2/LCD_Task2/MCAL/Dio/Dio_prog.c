...
DIO_U8_Pin_Config Dio_CfgPinsArray[PIN_COUNT] = {
		...
		// SWITCH TO CLEAR DISPLAY
		/*{DIO_U8_PORT_D,DIO_U8_PIN_6,INPUT,PULLUP_OFF},*/
		// EX_INT2
		...
		{DIO_U8_PORT_C,DIO_U8_PIN_3,INPUT,PULLUP_OFF},
		{DIO_U8_PORT_C,DIO_U8_PIN_4,INPUT,PULLUP_OFF},
		{DIO_U8_PORT_C,DIO_U8_PIN_5,INPUT,PULLUP_OFF},
		{DIO_U8_PORT_C,DIO_U8_PIN_6,INPUT,PULLUP_OFF}
};
